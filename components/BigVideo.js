  ...
  return (
    <>
      {w > 994 && <div className="video">
        ...
        {w > 1200 && w < 1399 && <iframe width="939" height="534" src="https://www.youtube.com/embed/BMsyssBXRsQ?autoplay=1&mute=1&showinfo=0&controls=0&loop=1&playlist=BMsyssBXRsQ" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>}
